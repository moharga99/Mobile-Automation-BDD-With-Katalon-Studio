...
Mobile.setText(findTestObject('android.widget.EditText - Nomor HPNo. kartu member'), '082114746495', 0)

Mobile.tap(findTestObject('android.widget.EditText - Masukkan Password'), 0)

Mobile.setText(findTestObject('android.widget.EditText - Masukkan Password'), 'Mukaanjing123!', 0)
